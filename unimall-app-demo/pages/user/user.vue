    ...
    <view class="container">  
		...
		>
			...
			<view class="tj-sction">
				<view class="tj-item" @click="navTo('/pages/user/cashout/cashout')">
				...
				<view class="tj-item" @click="navTo('/pages/order/list?state=70')">
			...
			<view class="order-section">
				<view class="order-item" @click="navTo('/pages/user/sign')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="../../static/user/数据icon@3x.png"></image>
					<text>签到</text>
				</view>
				<view class="order-item" @click="navTo('/pages/product/favorite')"  hover-class="common-hover" :hover-stay-time="50">
					<image src="../../static/user/链接icon@3x.png"></image>
					<text>收藏</text>
				</view>
				<view class="order-item" @click="navTo('/pages/order/findOrder')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="../../static/user/文章icon@3x.png"></image>
					<text>找回订单</text>
				</view>
				<view class="order-item" @click="navTo('/pages/user/onlineservice')" hover-class="common-hover"  :hover-stay-time="50">
					<image src="../../static/user/视频icon@3x.png"></image>
					<text>客服</text>
				</view>
			</view>
			
			<view class="my_tool">
				<text class="">我的工具</text>
				<text class="more">查看更多</text>
				<view class="order-section">
					<view class="order-item" @click="navTo('/pages/order/list?state=0')" hover-class="common-hover"  :hover-stay-time="50">
						<image src="../../static/user/我的订单icon@3x.png"></image>
						<text>我的订单</text>
					</view>
					<view class="order-item" @click="navTo('/pages/order/friendsOrder?state=0')"  hover-class="common-hover" :hover-stay-time="50">
						<image src="../../static/user/使用指南icon@3x.png"></image>
						<text>好友订单</text>
					</view>
					<view class="order-item" @click="navTo('/pages/order/shareOrder?state=30')" hover-class="common-hover"  :hover-stay-time="50">
						<image src="../../static/user/分享赚订单icon@3x.png"></image>
						<text>分享赚订单</text>
					</view>
					<view class="order-item" @click="navTo('/pages/user/myteam')" hover-class="common-hover"  :hover-stay-time="50">
						<image src="../../static/user/团队icon@3x.png"></image>
						<text>我的团队</text>
					</view>
				</view>
			</view>
			 ...
			 <view class="history-section icon">
				...
				<list-cell  title="邀请好友" @eventClick="navTo('/pages/user/invitefriend')"></list-cell>
				<list-cell  title="账户设置" @eventClick="navTo('/pages/set/set')"></list-cell>
				<list-cell  title="意见反馈" @eventClick="navTo('/pages/user/feedback')"></list-cell>
				<list-cell  title="关于我们" @eventClick="navTo('/pages/user/about')"></list-cell>
				<!-- <list-cell icon="icon-dizhi" iconColor="#5fcda2" title="地址管理" @eventClick="navTo('/pages/address/list')"></list-cell> -->
