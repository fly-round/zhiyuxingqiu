			...
			<view class="scrollView">
				...
				<view class="white-box">
					<view class="tx">
						...
						<view class="tx-grid" @click="navTo('/pages/user/cashout/withdraw')"><span class="tx-grid-comm-sign">立即提现</span></view>
					</view>
...
.flexView {
	...
	.scrollView {
		...
		.head-read {
			background: linear-gradient(to right, #9ffffc, #5bdcff);
