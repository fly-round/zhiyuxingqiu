	...
	<view class="container">
		...
		<view class="introduce-section">
			...
			<view class="price-box">
				...
				<text v-if="(isVip ? goods.vipPrice : goods.price) < goods.originalPrice" class="coupon-tip">
					{{ parseInt(((isVip ? goods.vipPrice : goods.price) / goods.originalPrice) * 100) / 10 }}折
				</text>
			</view>
			<view class="bot-row">
		...
		<view class="c-list">
			<view class="c-row b-b" @click="toggleSpec">
				...
				<view class="con">
					<text class="selected-text">{{ selectedSku.title ? selectedSku.title : '请选择' }}</text>
				</view>
		...
		<view class="page-bottom">
			...
			<view class="p-b-btn" type="primary" @click="sendOut()">
				<image src="../../static/good/分享2@3x.png"></image>
				<text>分享</text>
			</view>
			<view class="action-btn-group">
				<button type="primary" class=" action-btn no-border buy-now-btn" @click="buy">自购赚6块</button>
				<button type="primary" class=" action-btn no-border add-cart-btn" @click="share2">分享赚7块</button>
			</view>
		</view>
...
export default {
	...
	methods: {
		...
		share2() {
			...
			skuList[0] = skuItem;
			uni.navigateTo({
				url: '/pages/product/share?imgs=' + skuList[0].spuImg + '&title=' + skuList[0].title
			});
		},
		buy() {
			const that = this;
