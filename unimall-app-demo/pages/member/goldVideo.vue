	...
	<view class="content">
		<view class="courses_list">
			<view class="course_item">
				<image src="../../static/member/banner2@3x.png"></image>
				<view class="course_title">
					<text>7+365零基础短视频实战公开课</text>
					<text></text>
				</view>
				<view class="course_introd">
					<text>本课程是为短视频新手、抖音爱好者及从业者打造的聚焦抖音“拍摄剪辑+运营涨粉+变现带货”的全链路…</text>
	...
	export default {
		...
		methods: {
			...
			loadData(source) {
				...
				that.$api.request('admin.course', 'list', 
				failres => {
				...
				that.$api.request('goods', 'getGoodsPage',
				failres => {
					that.$api.msg(failres.errmsg)
					uni.hideLoading()
				}).then(res => {
